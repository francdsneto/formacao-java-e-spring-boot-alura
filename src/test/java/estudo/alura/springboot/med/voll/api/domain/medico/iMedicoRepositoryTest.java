...
import estudo.alura.springboot.med.voll.api.domain.consulta.Consulta;
import estudo.alura.springboot.med.voll.api.domain.endereco.DadosEndereco;
import estudo.alura.springboot.med.voll.api.domain.paciente.DadosCadastroPaciente;
...
class iMedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var medico = this.cadastrarMedico("Medico", "medico@voll.med", "123456", Especialidade.CARDIOLOGIA);
    ...
    @Test
    @DisplayName("Deveria devolver médico quando quando médico cadastrado está disponível na data")
